...
urlpatterns = [
    ...
    path('update-review/<int:pk>/', views.ReviewUpdateView.as_view(), name='update_review_detail'),
    path('delete-review/<int:pk>/', views.ReviewDeleteView.as_view(), name='delete_review_detail')
